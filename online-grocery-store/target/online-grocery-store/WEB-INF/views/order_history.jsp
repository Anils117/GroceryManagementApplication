                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">
                                    <fmt:formatDate value="${order.orderDateAsUtilDate}" pattern="MMM dd, yyyy 'at' hh:mm a" />
<%--                                    <fmt:formatDate value="${order.orderDate}" pattern="MMM dd, yyyy 'at' hh:mm a" />--%>
                                </small>
                            </div>
                            <div class="text-end">
                                <span class="badge bg-${order.status == 'PENDING' ? 'warning' : order.status == 'CONFIRMED' ? 'info' : order.status == 'PROCESSING' ? 'primary' : order.status == 'SHIPPED' ? 'info' : order.status == 'DELIVERED' ? 'success' : 'danger'}">${order.status}</span>
