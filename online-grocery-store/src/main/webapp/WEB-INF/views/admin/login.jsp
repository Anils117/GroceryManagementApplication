                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-5">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/login">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" id="email" name="email" 
                                       value="${email}" required placeholder="Enter admin email">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control form-control-lg" id="password" 
                                           name="password" required placeholder="Enter admin password">
                        ...
                        <div class="mt-4 p-3 bg-light rounded">
                            <h6 class="fw-bold text-dark mb-2">Demo Admin Credentials:</h6>
                            <small class="text-muted">
                                <strong>Email:</strong> admin@grocery.com<br>
